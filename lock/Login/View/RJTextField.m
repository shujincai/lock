...
//    }];
    ...
    [self.bottomLine mas_makeConstraints:^(MASConstraintMaker *make) {
        make.size.mas_equalTo(CGSizeMake(SCREEN_SIZE.width-CURRENT_SIZE(60), 1));
        make.left.equalTo(weakSelf.leftIcon.mas_left);
...
- (UILabel *) headerPlaceLabel{
    if(!_headerPlaceLabel){
        ...
        _headerPlaceLabel.textColor = _lineSelectedColor;
...
- (UIView *) bottomLine{
    if(!_bottomLine){
        ...
        _bottomLine.backgroundColor = COLOR_BLACK;
    }
    return _bottomLine;
}
