...
-(void)setUserKey:(UserKeyInfo*) userKeyInfo isOnline:(bool) isOnline;
...
-(void)setRegisterKey:(NSDate*)from to:(NSDate*)to registerKeyInfo:(RegisterKeyInfo*) registerKeyInfo;
